...
- Snakefile contains recipes (or rules) for creating files. 
...
Create a new file in the RStudio editor and call it "Snakefile"
...
It worked! There is an html file and a zip file.
...
CHALLENGE: How can you run this Snakefile to produce the outputs you just added?

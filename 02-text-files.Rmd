...
of text files. Let's try working with them!
...
It looks like there are four columns, and the quotes are multiline quotes.
...
files, I wanted to suggest looking into [the csvtk program](https://bioinf.shenwei.me/csvtk/usage/) -- we'll show you how to install it with conda in workshop 5, but we pre-installed on this binder.

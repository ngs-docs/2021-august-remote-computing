...
On Windows, you can open a new connection from MobaXterm simply by clicking.
@CTB
...
have a access to the system themselves because their account is disabled.
...
https://github.com/ngs-docs/2021-remote-computing-binder/
ncbi files
tricky things with URLs; signed URLS etc. etc.

wget/curl, -o/output options. do similar things.

vs git, and receiving files via e-mail (?)

challenge:
- pick a book from https://www.gutenberg.org/

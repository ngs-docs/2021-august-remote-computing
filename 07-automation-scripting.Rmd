...
> example with echo statement in a script?
...
> somewhere here - mini-section on variables
...
> - run the same loop in a shell script ...?
...
> (add demo/exercise here for running script in loop)



> below stuff is out of place, move somewhere

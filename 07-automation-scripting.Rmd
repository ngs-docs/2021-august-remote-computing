...
> to add:
> - subsets and renaming file names; data forensics - check subsets of your data for potential formatting issues
> - brief mention of wildcards...
> - does "how to conduct long-running analyses" refer to screen/tmux?


## What is a script?

- it's like writing down a recipe of commands for the computer to execute
